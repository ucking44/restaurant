...
<html lang="en">
    ...
    <body data-spy="scroll" data-target="#template-navbar">
        ...
        <!--==  7. Afordable Pricing  ==-->
        <section id="menu_list" class="menu-list">
            <div id="w">
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="section-header">
                                        <h2 class="pricing-title">Our Menu List At Affordable price</h2>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control reserve-form empty iconified" name="name" id="name" required="" placeholder="  &#xf007;  Name">
                                            </div>
                                            <div class="form-group">
                                                <input type="email" name="email" class="form-control reserve-form empty iconified" id="email" required="" placeholder="  &#xf1d8;  e-mail">
                                            </div>
                                        </div>

                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <input type="number" class="form-control reserve-form empty iconified" name="phone" id="phone" required="" placeholder="  &#xf095;  Phone">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control reserve-form empty iconified" name="date_and_time" id="datetimepicker1" required="" placeholder="&#xf017;  Time">
                                            </div>
                                        </div>

                                        <div class="col-md-12 col-sm-12">
                                            <textarea type="text" name="message" class="form-control reserve-form empty iconified" id="message" rows="3" required="" placeholder="  &#xf086;  We're listening"></textarea>
                                        </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2021 <a href="#"> Ugo's Kitchen</a>
                                Developed by <a href="https://github.com/ucking44">Uchechukwu Ogbuleke Kingsley</a>
                            </p>
                        </div>
                    </div>
                </div>
